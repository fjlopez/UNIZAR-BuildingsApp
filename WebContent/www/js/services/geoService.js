...
UZCampusWebMapApp.service('geoService', function(sharedProperties, infoService, APP_CONSTANTS) {
    ...
    // FunciÛn encargada de aÒadir el marcador sobre el edificio para mostrar despuÈs la informaciÛn de dicho edificio
    ...
    /* MÈtodo para crear Popups en los campus que no estÈn completados con sus edficios
    ...
    function rellenarCampus($scope){
        ...
        L.marker([41.6830208, -0.8886136]).addTo($scope.map)
            .bindPopup('<div class=\"text-center\"><b>Campus Rio Ebro</b><br>C/Mar√≠a de Luna, s/n</div>' +
        ...
        L.marker([41.6465754, -0.8878908]).addTo($scope.map)
            .bindPopup('<div class=\"text-center\"><b>Campus Gran V√≠a, Facultad Econ√≥micas</b><br>Paseo de la Gran V√≠a, 2</div>' +
            '<button class="button button-small button-positive button-how" onclick="location.href ='+redireccionPopup+'" >'+$scope.translation.HOWTOARRIVE+' </button>');
    ...
    this.crearPlano= function ($scope,$http, infoService){
        ...
        /*
         Funcion que dada la estancia seleccionada, muestra la informaciÛn relativa
         */
        ...
        //Function que a√±ade la leyenda al plano
